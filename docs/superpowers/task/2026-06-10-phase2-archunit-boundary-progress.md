...
- 剩余历史白名单集中点：`BaseAgent`、`CompetitorAnalysisAgent`、`CollectorAgent`、`SchemaExtractorAgent`、`QualityReviewAgent`、`ReportWriterAgent`、`WorkflowFactory`、`TaskDefinitionAppService`、`TaskRuntimeCommandAppService`。
