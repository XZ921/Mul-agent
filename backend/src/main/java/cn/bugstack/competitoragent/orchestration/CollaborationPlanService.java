        ...
        return CollaborationPlan.builder()
                ...
                .agentRoleAssignments(List.of(
                        ...
                        role("role-writer-01",
                                ...
                                normalizedGoal),
                        role("role-citation-01",
                                "CITATION",
                                "核查报告引用覆盖、证据编号有效性和来源可信度，阻止无引用强结论进入 Reviewer。",
                                List.of("CitationCheckResult", "AgentSuggestion"),
                                List.of("role-writer-01"),
                                "citation coverage must pass before reviewer",
                                normalizedGoal),
                        role("role-reviewer-01",
                                "REVIEWER",
                                "对最终报告做质量审查，并把缺口交由 Orchestrator 决策。",
                                List.of("QualityReview", "RevisionDirective"),
                                List.of("role-citation-01"),
