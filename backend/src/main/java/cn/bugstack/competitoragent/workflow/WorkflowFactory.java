...
public class WorkflowFactory {
    ...
    public WorkflowPlan buildPlan(AnalysisTask task) {
        ...
        for (int competitorIndex = 0; competitorIndex < competitorNames.size(); competitorIndex++) {
            ...
            for (int planIndex = 0; planIndex < sourcePlans.size(); planIndex++) {
                ...
                planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                        .nodeName(nodeName)
                        .displayName("Collect " + sourcePlan.getSourceType() + " - " + competitorName)
                        ...
                        .notes("Auto-generated by source discovery")
                        .build());
            }
        }
        ...
        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                ...
                .displayName("Extract competitor knowledge schema")
                ...
                .notes("Aggregate evidence and enforce source traceability")
                .build());

        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                .nodeName("analyze_competitors")
                .displayName("Cross-competitor analysis")
        ...
        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                ...
                .displayName("Write competitor report")
        ...
        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                ...
                .displayName("Review report quality")
        ...
        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                ...
                .displayName("Rewrite report by revision plan")
                .agentType(AgentType.WRITER.name())
                ...
                .notes("Runs only when the initial review requests a rewrite.")
                .build());

        planNodes.add(WorkflowPlan.WorkflowPlanNode.builder()
                .nodeName("quality_check_final")
                .displayName("Final review after revision")
                .agentType(AgentType.REVIEWER.name())
                ...
                .notes("Runs only after rewrite to close the review loop.")
                .build());
